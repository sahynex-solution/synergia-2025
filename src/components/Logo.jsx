...
export default function Logo({ position }) {
  ...
  return (
    <Fragment>
      ...
      <div className="absolute w-3/5 max-w-md z-10 flex justify-center items-center">
        <div
          className="absolute w-screen h-screen"
          style={{
            background:
              "radial-gradient(circle, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 10%,rgba(0,0,0,0.4) 30%, rgba(0,0,0,0) 50%)",
          }}
        />
        <motion.svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 352.01 217.72"
          className={`absolute transition-opacity duration-500 select-none -mt-44 ${
            fadeIn ? "opacity-100" : "opacity-0"
          }`}
          style={{ x: position }}
        >

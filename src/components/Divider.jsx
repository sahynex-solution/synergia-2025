  ...
  return (
    ...
    >
      <div className="flex flex-row w-full items-center justify-center relative">
        {/* Gradient line */}
        <div
          className="w-full h-1 mt-8 rounded-full opacity-70 -z-20"
          style={{
        ...
        {/* Center accent */}
        <div className="absolute mt-8 p-4 flex items-center justify-center">
          ...
          >
            <defs>
              ...
              >
                ...
                {midColor && <stop offset="50%" stopColor={midColor} />}
